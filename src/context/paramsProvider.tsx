...
const ParamsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <ParamsContext.Provider value={{ colours, saveColour, updateColour, removeColour, incrementer, primaryColour, setPrimaryColour }}>
            {children}
