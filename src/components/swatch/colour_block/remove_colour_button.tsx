...
const RemoveColourButton: React.FC<{ lum: number, id: string, handleSidebar: () => void }> = ({ lum, id, handleSidebar }) => {
    ...
    const onRemoveClick = (id: string) => {
        ...
        colourContext?.removeColour(id)
    };

    return (
        <button className='justify-end' onClick={() => onRemoveClick(id)}>
            { useWhite ? 
